...
constexpr PascalErrorCode MISSING_NEW_SPECIAL_SYMBOL = PascalErrorCode::MISSING_NEW_SPECIAL_SYMBOL;
constexpr PascalErrorCode WHEN_OUT_OF_LOOP = PascalErrorCode::WHEN_LOOP;
