...
void PascalToken::initialize()
{
    ...
    vector<PascalTokenType> ss_keys =
    {
		...
		//PascalTokenType::EQUALS_EXIT_ARROW,
		//PascalTokenType::EQUALS_EQUALS_EQUALS_EXIT_ARROW
    };
    ...
    vector<string> ss_names =
    {
        ...
        "LEFT_BRACE", "RIGHT_BRACE", "UP_ARROW", "DOT_DOT","EXIT_ARROW"//,"EQUALS_EXIT_ARROW","EQUALS_EQUALS_EQUALS_EXIT_ARROW"
		//,"EQUALS_EQUALS"
    };
