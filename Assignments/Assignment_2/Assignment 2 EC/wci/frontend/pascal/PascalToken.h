...
enum class PascalTokenType
{
    ...
    UP_ARROW, DOT_DOT,EXIT_ARROW,//,EQUALS_EXIT_ARROW,EQUALS_EQUALS_EQUALS_EXIT_ARROW,
	//EQUALS_EQUALS,
...
//constexpr PascalTokenType PT_EQUALS_EXIT_ARROW= PascalTokenType::EQUALS_EXIT_ARROW;
//constexpr PascalTokenType PT_EQUALS_EQUALS_EQUALS_EXIT_ARROW= PascalTokenType::EQUALS_EQUALS_EQUALS_EXIT_ARROW;
